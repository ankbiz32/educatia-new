        ...
        <section class="inner-banner" style="background-image: url(<?=base_url()?>assets/images/privacy-header.jpg);">
            <div class="container">
                <ul class="list-unstyled thm-breadcrumb">
                    <li><a href="#">Home</a></li>
                    <li class="active"><a href="#">Privacy Policy</a></li>
                </ul><!-- /.list-unstyled -->
                <h2 class="inner-banner__title"><small>Privacy Policy</small></h2><!-- /.inner-banner__title -->
            </div><!-- /.container -->
        ...
        <section class="blog-details trpl pb-0">
            <div class="container">
                    ...
                    <h2>7. Advertisements on ramrajservices.com</h2>
