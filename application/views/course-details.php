...
<body>
    ...
    <div class="page-wrapper">
        ...
        <section class="inner-banner" style="background-image: url(assets/images/courses-header.jpg);">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="course-details__price">
                            ...
                            <p class="course-details__price-amount">FREE &emsp;<small><del>Rs. 2599/-</del></small></p><!-- /.course-details__price-amount -->
