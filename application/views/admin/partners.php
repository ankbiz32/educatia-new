...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                  <h1 class="m-0 text-dark"><i class="fa fa-users"></i>&nbsp;&nbsp;Partners</h1>
              </div><!-- /.col -->
              <div class="col-sm-6">
      ...
      <div class="row mt-3 mb-4">
        ...
        <?php foreach ($data as $d){?>
          <div class="p-0 mr-4 mb-5 col-lg-2 col-md-2 col-sm-4 col-xs-6">
            <img src="<?=base_url('assets/images/').$d->img_src?>" alt="Image" height="170" class="p-0 ml-0 col-md-12 mb-1 img-fluid" style="object-fit:cover;">
            <div class="p-0 m-0 col-md-12 text-align-center d-flex">
                <a href="<?=base_url('Delete/Partner/'.$d->id)?>" onclick="confirmation(event)" class="btn btn-flat m-0 del-btn btn-danger col-md-6" title="Delete Image"><i class="fa fa-trash-alt"></i></a>
          ...
          <div class="modal fade" id="edit<?=$d->id?>">
              <div class="modal-dialog">
                  ...
                  <div class="modal-body">
                      <form role="form" method="post" enctype= "multipart/form-data" action="<?php echo base_url();?>Edit/Partner/<?=$d->id?>">
                         <div class="row">
...
<!-- add   modal -->
    <div class="modal fade" id="add">
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                <form role="form" method="post" enctype= "multipart/form-data" action="<?= base_url();?>Add/Partner">
                    <div class="row">
                    <div class="input-group">
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" id="img" name="img" required>
